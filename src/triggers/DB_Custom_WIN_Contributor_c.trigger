trigger DB_Custom_WIN_Contributor_c on WIN_Contributor__c ( before delete, after insert, after update, after undelete )
{
	try
	{
	...
	{
		CRMfusionDBR101.DB_TriggerHandler.handleTriggerException( ex, 'DB_Custom_WIN_Contributor_c' );
	}
}