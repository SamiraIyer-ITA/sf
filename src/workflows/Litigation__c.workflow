...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <fieldUpdates>
        <fullName>Update_Owner_to_Open_Litigation_Queue</fullName>
        <field>OwnerId</field>
        <lookupValue>Litigations_Open_Queue</lookupValue>
        <lookupValueType>Queue</lookupValueType>
        <name>Update Owner to Open Litigation Queue</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>LookupValue</operation>
        <protected>false</protected>
    </fieldUpdates>
    ...
    <rules>
        <fullName>Queue Open Litigation</fullName>
        <actions>
            <name>Update_Owner_to_Open_Litigation_Queue</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
