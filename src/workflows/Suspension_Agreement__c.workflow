...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <rules>
        ...
        <active>true</active>
        <formula>AND($Setup.Master_Automation__c.WorkflowRulesEnabled__c == true, Locked__c == false, OR(  ISNEW(),  ISBLANK( This_Investigation_has_a_Susp_Agreement__c ),  ISCHANGED( This_Investigation_has_a_Susp_Agreement__c )  ) )</formula>
