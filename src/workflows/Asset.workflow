...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <rules>
        ...
        <formula>AND(Inactive_Status_Reason__r.Name = &quot;Lapse&quot;, Product2.Name = &apos;EU-US Certification&apos;)</formula>
    ...
    <rules>
        ...
        <formula>AND(Inactive_Status_Reason__r.Name = &quot;Persistent Failure to Comply&quot;, Product2.Name = &apos;EU-US Certification&apos;)</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
        ...
        <formula>AND(Inactive_Status_Reason__r.Name = &quot;Withdrawal&quot;, Product2.Name = &apos;EU-US Certification&apos;)</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
        ...
        <formula>AND(ISPICKVAL(Status,&apos;Active&apos;), Product2.Name = &apos;EU-US Certification&apos;)</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    ...
    <rules>
        ...
        <formula>NOT(ISBLANK(UsageEndDate)) &amp;&amp;  ISPICKVAL(Status, &apos;active&apos;) &amp;&amp; Product2.Name = &apos;EU-US Certification&apos;</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
        <workflowTimeTriggers>
            <actions>
                <name>Expire_Asset</name>
